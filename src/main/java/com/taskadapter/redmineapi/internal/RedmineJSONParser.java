...
public class RedmineJSONParser {
	...
	public static final JsonObjectParser<Tracker> TRACKER_PARSER = new JsonObjectParser<Tracker>() {
		@Override
		public Tracker parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<IssueStatus> STATUS_PARSER = new JsonObjectParser<IssueStatus>() {
		@Override
		public IssueStatus parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Project> MINIMAL_PROJECT_PARSER = new JsonObjectParser<Project>() {
		@Override
		public Project parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Issue> ISSUE_PARSER = new JsonObjectParser<Issue>() {
		@Override
		public Issue parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<User> USER_PARSER = new JsonObjectParser<User>() {
		@Override
		public User parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Group> GROUP_PARSER = new JsonObjectParser<Group>() {
		@Override
		public Group parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<CustomField> CUSTOM_FIELD_PARSER = new JsonObjectParser<CustomField>() {
		@Override
		public CustomField parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Journal> JOURNAL_PARSER = new JsonObjectParser<Journal>() {
		@Override
		public Journal parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<JournalDetail> JOURNAL_DETAIL_PARSER = new JsonObjectParser<JournalDetail>() {
		@Override
		public JournalDetail parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Attachment> ATTACHMENT_PARSER = new JsonObjectParser<Attachment>() {
		@Override
		public Attachment parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<IssueRelation> RELATION_PARSER = new JsonObjectParser<IssueRelation>() {
		@Override
		public IssueRelation parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<News> NEWS_PARSER = new JsonObjectParser<News>() {
		@Override
		public News parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Version> VERSION_PARSER = new JsonObjectParser<Version>() {
		@Override
		public Version parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<IssueCategory> CATEGORY_PARSER = new JsonObjectParser<IssueCategory>() {
		@Override
		public IssueCategory parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<TimeEntry> TIME_ENTRY_PARSER = new JsonObjectParser<TimeEntry>() {
		@Override
		public TimeEntry parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<SavedQuery> QUERY_PARSER = new JsonObjectParser<SavedQuery>() {
		@Override
		public SavedQuery parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<String> UPLOAD_TOKEN_PARSER = new JsonObjectParser<String>() {
		@Override
		public String parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Role> ROLE_PARSER = new JsonObjectParser<Role>() {
		@Override
		public Role parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Membership> MEMBERSHIP_PARSER = new JsonObjectParser<Membership>() {
		@Override
		public Membership parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Changeset> CHANGESET_PARSER = new JsonObjectParser<Changeset>() {
		@Override
		public Changeset parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<Watcher> WATCHER_PARSER = new JsonObjectParser<Watcher>() {
		@Override
		public Watcher parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<IssuePriority> ISSUE_PRIORITY_PARSER = new JsonObjectParser<IssuePriority>() {
		@Override
		public IssuePriority parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<TimeEntryActivity> TIME_ENTRY_ACTIVITY_PARSER = new JsonObjectParser<TimeEntryActivity>() {
		@Override
		public TimeEntryActivity parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<WikiPage> WIKI_PAGE_PARSER = new JsonObjectParser<WikiPage>() {
		@Override
		public WikiPage parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<WikiPageDetail> WIKI_PAGE_DETAIL_PARSER = new JsonObjectParser<WikiPageDetail>() {
		@Override
		public WikiPageDetail parse(final JSONObject input) throws JSONException {
	...
	public static final JsonObjectParser<CustomFieldDefinition> CUSTOM_FIELD_DEFINITION_PARSER = new JsonObjectParser<CustomFieldDefinition>() {
		@Override
		public CustomFieldDefinition parse(final JSONObject input) throws JSONException {
			return parseCustomFieldDefinition(input);
		}
	};

	public static JSONObject getResponse(final String body) throws JSONException {
		System.out.println(body);
		return new JSONObject(body);
	}

	public static JSONObject getResponseSingleObject(final String body, final String key) throws JSONException {
		final JSONObject bodyJson = new JSONObject(body);
		return JsonInput.getObjectNotNull(bodyJson, key);
	}

	public static Attachment parseAttachments(final JSONObject content)
	...
	public static IssueCategory parseCategory(final JSONObject content)
			throws JSONException {
	...
	public static Changeset parseChangeset(final JSONObject content)
			throws JSONException {
	...
	public static CustomField parseCustomField(final JSONObject content)
			throws JSONException {
		...
		if (!content.has("multiple")) {
			...
			final Object value = content.get("value");
			if(value instanceof JSONArray) {
				final JSONArray tmp = (JSONArray) value;
	...
	public static CustomFieldDefinition parseCustomFieldDefinition(final JSONObject content)
			throws JSONException {
		...
		if (content.has("possible_values")) {
			final JSONArray possible_values = content.getJSONArray("possible_values");
			for (int i = 0; i < possible_values.length(); i++) {
				final JSONObject valueObject = possible_values.getJSONObject(i);
				result.getPossibleValues().add(valueObject.getString("value"));
			}
		}
		if (content.has("trackers")) {
			final JSONArray possible_values = content.getJSONArray("trackers");
			for (int i = 0; i < possible_values.length(); i++) {
				final JSONObject valueObject = possible_values.getJSONObject(i);
				final int id = valueObject.getInt("id");
				final String name = valueObject.getString("name");
				result.getTrackers().add(TrackerFactory.create(id, name));
			}
		}
		if (content.has("roles")) {
			final JSONArray possible_values = content.getJSONArray("roles");
			for (int i = 0; i < possible_values.length(); i++) {
				final JSONObject valueObject = possible_values.getJSONObject(i);
				final int id = valueObject.getInt("id");
				final String name = valueObject.getString("name");
				final Role role = RoleFactory.create(id);
				role.setName(name);
	...
	public static List<String> parseErrors(final String responseBody) throws JSONException {
	...
	public static Group parseGroup(final JSONObject content) throws JSONException {
	...
	public static Issue parseIssue(final JSONObject content) throws JSONException {
	...
	public static IssuePriority parseIssuePriority(final JSONObject content)
			throws JSONException {
	...
	public static Journal parseJournal(final JSONObject content) throws JSONException {
	...
	public static JournalDetail parseJournalDetail(final JSONObject content) throws JSONException {
	...
	public static Membership parseMembership(final JSONObject content)
			throws JSONException {
	 ...
	 */
	public static Project parseMinimalProject(final JSONObject content)
			throws JSONException {
	...
	public static News parseNews(final JSONObject object) throws JSONException {
	 ...
	 * @return parsed project.
	 */
	public static Project parseProject(final JSONObject content) throws JSONException {
		final Project result = ProjectFactory.create(JsonInput.getInt(content, "id"));
		result.setIdentifier(JsonInput.getStringOrNull(content, "identifier"));
		result.setName(JsonInput.getStringNotNull(content, "name"));
		result.setDescription(JsonInput
	...
	public static IssueRelation parseRelation(final JSONObject content)
			throws JSONException {
	...
	public static Role parseRole(final JSONObject content) throws JSONException {
	...
	public static SavedQuery parseSavedQuery(final JSONObject object)
			throws JSONException {
	 ...
	 */
	public static IssueStatus parseStatus(final JSONObject object)
			throws JSONException {
	...
	public static TimeEntry parseTimeEntry(final JSONObject object)
			throws JSONException {
		/**
	...
	public static TimeEntryActivity parseTimeEntryActivity(final JSONObject content)
			throws JSONException {
	 ...
	 * @return parsed tracker.
	 */
	public static Tracker parseTracker(final JSONObject object) throws JSONException {
		final int id = JsonInput.getInt(object, "id");
		final String name = JsonInput.getStringNotNull(object, "name");
		return TrackerFactory.create(id, name);
	}

	public static User parseUser(final JSONObject content) throws JSONException {
		...
		for (final Membership m : result.getMemberships()) {
			m.setUser(result);
		}
	...
	public static Version parseVersion(final JSONObject content) throws JSONException {
	...
	public static Watcher parseWatcher(final JSONObject content) throws JSONException {
		final Watcher result = WatcherFactory.create(JsonInput.getIntOrNull(content, "id"));
		result.setName(JsonInput.getStringOrNull(content, "name"));
		return result;
	}

	public static WikiPage parseWikiPage(final JSONObject object) throws JSONException {
		final WikiPage wikiPage = WikiPageFactory.create(JsonInput.getStringNotNull(object, "title"));
	...
	public static WikiPageDetail parseWikiPageDetail(final JSONObject object) throws JSONException {
		final WikiPageDetail wikiPage = new WikiPageDetail();
	 ...
	 */
	private static Date getDateOrNull(final JSONObject obj, final String field) throws JSONException {
		...
		try {
			...
			throw new JSONException("Cannot parse this date: " + dateStr + " " + e);
		}
	}
}
