...
public final class Transport implements ITransport {
	...
	static class EntityConfig<T> {
		...
		public EntityConfig(final String objectField, final String urlPrefix, final JsonObjectWriter<T> writer,
				final JsonObjectParser<T> parser) {
			super();
	...
	static {
		OBJECT_CONFIGS.put(Project.class,
				config("project", "projects", RedmineJSONBuilder.PROJECT_WRITER, RedmineJSONParser.PROJECT_PARSER));
		OBJECT_CONFIGS.put(Issue.class,
				config("issue", "issues", RedmineJSONBuilder.ISSUE_WRITER, RedmineJSONParser.ISSUE_PARSER));
		OBJECT_CONFIGS.put(User.class,
				config("user", "users", RedmineJSONBuilder.USER_WRITER, RedmineJSONParser.USER_PARSER));
		OBJECT_CONFIGS.put(Group.class,
				config("group", "groups", RedmineJSONBuilder.GROUP_WRITER, RedmineJSONParser.GROUP_PARSER));
		OBJECT_CONFIGS.put(IssueCategory.class, config("issue_category", "issue_categories",
				RedmineJSONBuilder.CATEGORY_WRITER, RedmineJSONParser.CATEGORY_PARSER));
		OBJECT_CONFIGS.put(Version.class,
				config("version", "versions", RedmineJSONBuilder.VERSION_WRITER, RedmineJSONParser.VERSION_PARSER));
		OBJECT_CONFIGS.put(TimeEntry.class, config("time_entry", "time_entries", RedmineJSONBuilder.TIME_ENTRY_WRITER,
				RedmineJSONParser.TIME_ENTRY_PARSER));
		OBJECT_CONFIGS.put(News.class, config("news", "news", null, RedmineJSONParser.NEWS_PARSER));
		OBJECT_CONFIGS.put(IssueRelation.class,
				config("relation", "relations", RedmineJSONBuilder.RELATION_WRITER, RedmineJSONParser.RELATION_PARSER));
		OBJECT_CONFIGS.put(Tracker.class, config("tracker", "trackers", null, RedmineJSONParser.TRACKER_PARSER));
		OBJECT_CONFIGS.put(IssueStatus.class,
				config("status", "issue_statuses", null, RedmineJSONParser.STATUS_PARSER));
		OBJECT_CONFIGS.put(SavedQuery.class, config("query", "queries", null, RedmineJSONParser.QUERY_PARSER));
		OBJECT_CONFIGS.put(Role.class, config("role", "roles", null, RedmineJSONParser.ROLE_PARSER));
		OBJECT_CONFIGS.put(Membership.class, config("membership", "memberships", RedmineJSONBuilder.MEMBERSHIP_WRITER,
				RedmineJSONParser.MEMBERSHIP_PARSER));
		OBJECT_CONFIGS.put(IssuePriority.class,
				config("issue_priority", "issue_priorities", null, RedmineJSONParser.ISSUE_PRIORITY_PARSER));
		OBJECT_CONFIGS.put(TimeEntryActivity.class, config("time_entry_activity", "time_entry_activities", null,
				RedmineJSONParser.TIME_ENTRY_ACTIVITY_PARSER));

		OBJECT_CONFIGS.put(Watcher.class, config("watcher", "watchers", null, RedmineJSONParser.WATCHER_PARSER));

		OBJECT_CONFIGS.put(WikiPage.class, config("wiki_page", "wiki_pages", null, RedmineJSONParser.WIKI_PAGE_PARSER));

		OBJECT_CONFIGS.put(WikiPageDetail.class,
				config("wiki_page", null, null, RedmineJSONParser.WIKI_PAGE_DETAIL_PARSER));
		OBJECT_CONFIGS.put(CustomFieldDefinition.class,
				config("custom_field", "custom_fields", null, RedmineJSONParser.CUSTOM_FIELD_DEFINITION_PARSER));
	}

	private static final String CHARSET = "UTF-8";

	private static <T> EntityConfig<T> config(final String objectField, final String urlPrefix,
	...
	private static <T> T parseResponse(final String response, final String tag, final JsonObjectParser<T> parser)
	...
	private static void setEntity(final HttpEntityEnclosingRequest request, final String body,
		...
		try {
			...
			throw new RedmineInternalError("Required charset " + CHARSET + " is not supported", e);
		}
	...
	public Transport(final URIConfigurator configurator, final CloseableHttpClient client) {
		...
		authenticator = new RedmineAuthenticator<HttpResponse>(baseCommunicator, CHARSET);
		final ContentHandler<BasicHttpResponse, BasicHttpResponse> errorProcessor = new RedmineErrorHandler();
		errorCheckingCommunicator = Communicators.fmap(authenticator,
				Communicators.compose(errorProcessor, Communicators.transportDecoder()));
		final Communicator<String> coreCommunicator = Communicators.fmap(errorCheckingCommunicator,
				Communicators.contentReader());
		communicator = Communicators.simplify(coreCommunicator, Communicators.<String> identityHandler());
	}
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#addChildEntry(java.lang.
	 * Class, java.lang.String, T, org.apache.http.NameValuePair)
	 */
	@Override
	public <T> T addChildEntry(final Class<?> parentClass, final String parentId, final T object,
		...
		final URI uri = getURIConfigurator().getChildObjectsURI(parentClass, parentId, object.getClass(), params);
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.taskadapter.redmineapi.internal.ITransport#addObject(T,
	 * org.apache.http.NameValuePair)
	 */
	@Override
	public <T> T addObject(final T object, final NameValuePair... params) throws RedmineException {
		final EntityConfig<T> config = getConfig(object.getClass());
		if (config.writer == null) {
			throw new RuntimeException(
					"can't create object: writer is not implemented or is not registered in RedmineJSONBuilder for object "
							+ object);
		}
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.taskadapter.redmineapi.internal.ITransport#addUserToGroup(int,
	 * int)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#addWatcherToIssue(int,
	 * int)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#deleteChildId(java.lang.
	 * Class, java.lang.String, T, java.lang.Integer)
	 */
	@Override
	public <T> void deleteChildId(final Class<?> parentClass, final String parentId, final T object,
			final Integer value) throws RedmineException {
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#deleteObject(java.lang.
	 * Class, java.lang.String)
	 */
	@Override
	public <T extends Identifiable> void deleteObject(final Class<T> classs, final String id) throws RedmineException {
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#download(java.lang.String,
	 * com.taskadapter.redmineapi.internal.comm.ContentHandler)
	 */
	@Override
	public <R> R download(final String uri, final ContentHandler<BasicHttpResponse, R> handler)
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getChildEntries(java.lang.
	 * Class, int, java.lang.Class)
	 */
	@Override
	public <T> List<T> getChildEntries(final Class<?> parentClass, final int parentId, final Class<T> classs)
			throws RedmineException {
	 ...
	 */
	@Override
	public <T> List<T> getChildEntries(final Class<?> parentClass, final String parentKey, final Class<T> classs)
			throws RedmineException {
		final EntityConfig<T> config = getConfig(classs);
		final URI uri = getURIConfigurator().getChildObjectsURI(parentClass, parentKey, classs,
				new BasicNameValuePair("limit", String.valueOf(objectsPerPage)));
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getChildEntry(java.lang.
	 * Class, java.lang.String, java.lang.Class, java.lang.String,
	 * org.apache.http.NameValuePair)
	 */
	@Override
	public <T> T getChildEntry(final Class<?> parentClass, final String parentId, final Class<T> classs,
			final String childId, final NameValuePair... params) throws RedmineException {
		final EntityConfig<T> config = getConfig(classs);
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getCurrentUser(org.apache.
	 * http.NameValuePair)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getObject(java.lang.Class,
	 * java.lang.Integer, org.apache.http.NameValuePair)
	 */
	@Override
	public <T> T getObject(final Class<T> classs, final Integer key, final NameValuePair... args)
			throws RedmineException {
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getObjectsList(java.lang.
	 * Class, java.util.Collection)
	 */
	@Override
	public <T> List<T> getObjectsList(final Class<T> objectClass, final Collection<? extends NameValuePair> params)
			throws RedmineException {
	 ...
	 */
	@Override
	public <T> List<T> getObjectsList(final Class<T> objectClass, final NameValuePair... params)
			throws RedmineException {
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#getObjectsListNoPaging(
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#setCredentials(java.lang.
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#setLogin(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#setObjectsPerPage(int)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#setOnBehalfOfUser(java.
	 * lang.String)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.taskadapter.redmineapi.internal.ITransport#setPassword(java.lang.
	 * String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.taskadapter.redmineapi.internal.ITransport#updateObject(T,
	 * org.apache.http.NameValuePair)
	 */
	@Override
	public <T extends Identifiable> void updateObject(final T obj, final NameValuePair... params)
			throws RedmineException {
		...
		final URI uri = getURIConfigurator().getObjectURI(obj.getClass(), Integer.toString(id));
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.taskadapter.redmineapi.internal.ITransport#upload(java.io.
	 * InputStream)
	 */
	@Override
	...
	@Override
	public String upload(final InputStream _wrapper, final long _size) throws RedmineException {
		final URI uploadURI = getURIConfigurator().getUploadURI();
		final HttpPost request = new HttpPost(uploadURI);
		final AbstractHttpEntity entity = new InputStreamEntity(_wrapper, _size);
		/* Content type required by a Redmine */
		entity.setContentType("application/octet-stream");
		request.setEntity(entity);
